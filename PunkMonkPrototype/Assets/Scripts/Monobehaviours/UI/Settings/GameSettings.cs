...
public class GameSettings
{
    ...
    [HideInInspector]
    [SerializeField]
    // Increment everytime this script is changed
    ...
    public void SetAllTo(GameSettings a_other)
    {
    ...
    public void SetGameplayTo(GameSettings a_other)
    {
        // Gameplay
    ...
    public void SetGraphicsTo(GameSettings a_other)
    {
        // Graphics
    ...
    public void SetSoundsTo(GameSettings a_other)
    {
        // Sounds
    ...
    public static GameSettings Load(string a_name)
    {
        if (File.Exists(Application.persistentDataPath + "/" + a_name + ".settings"))
        {
            ...
            GameSettings loadedSettings = bf.Deserialize(file) as GameSettings;
            file.Close();

            if (loadedSettings.version != currentVersion)
            {
                Debug.Log("Outdated Settings, making new ones.");
                return null;
            }
