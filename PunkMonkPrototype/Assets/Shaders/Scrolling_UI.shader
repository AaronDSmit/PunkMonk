...
////// Lighting:
////// Emissive:
                float4 node_1894 = _Time;
                float4 node_7910 = _Time;
                float2 node_4422 = ((i.uv0+node_1894.g*float2(0,0))+(float2(_U_Speed,_V_Speed)*node_7910.g));
                ...
                return fixed4(finalColor,(node_3936.g*_Opacity*_Mask_var.rgb.r*_Colour.a));
            }
            ENDCG
        }
    }
